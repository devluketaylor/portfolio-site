...
export const pageLinks = [{ name: "Home", href: "/", rel: Page.Home }, { name: "Projects", href: "/projects", rel: Page.Projects }, { name: "Blog", href: "/blog", rel: Page.Blog }, { name: "About", href: "/about", rel: Page.About }, { name: "Contact", href: "/contact", rel: Page.Contact }];
